...
@userge.on_cmd("karbon", about={
    ...
    'flags': {
        ...
        '-b': "blue -> 0-255",
        '-a': "alpha -> 0-100"},
    'usage': "{tr}karbon [flags] [theme] | [language] | [text | reply to msg]",
    'examples': [
        "{tr}karbon haha", "{tr}karbon vscode | hoho",
        "{tr}karbon -r100 -g75 -b50 -a50 blackboard | hola"],
    'themes': [
...
async def karbon_(message: Message):
